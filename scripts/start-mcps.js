...
// Group servers by priority and dependencies
const serverGroups = {
  core: ['MetaMCP', 'supabase'],
  browser: ['playwright', 'puppeteer', 'browsermcp'],
  tools: ['context7', 'sequential-thinking', 'github', 'figma'],
  system: ['filesystem', 'memory', 'fetch']
};
...
async function startMCPServer(name, serverConfig) {
  ...
  const env = {
    ...process.env,
    ...serverConfig.env,
    METAMCP_API_KEY: process.env.METAMCP_API_KEY || "sk_mt_bJsy2v3gzD4FLFs0Xh5dNhvrUqKGwYkwZz4BQKfnbU9jsNsIkrYBKxUXJirwydhB"
  };
...
async function startAllServers() {
  ...
  const results = {
    ...
    system: await startServerGroup('System', serverGroups.system)
  };
